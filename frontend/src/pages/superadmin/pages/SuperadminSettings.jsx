            ...
            <div className="flex flex-col md:flex-row gap-10 md:gap-16 items-start">
              ...
              <div className="flex flex-col items-center md:items-start min-w-[120px]">
                ...
                <div className="w-20 h-20 md:w-24 md:h-24 rounded-full bg-[#757FF6] flex items-center justify-center mb-2">
                  <UserOutlined className="text-white text-2xl md:text-3xl mt-4" />
                </div>
                <Button
              ...
              <div className="flex-1 flex flex-col justify-center w-full md:pl-4 md:ml-12">
                <input
                  ...
                  value="  superadmin"
                  readOnly
                  className="w-full h-12 p-4 bg-white border border-gray-200 rounded-lg focus:outline-none text-lg mb-8 shadow-sm"
                  style={{ fontFamily: 'Poppins, sans-serif' }}
                />
                <Button
                  className="text-white font-medium mb-2 mt-8"
                  style={{
                    borderRadius: '10px',
                    border: 'none',
